...
// User_ID = ADMIN , Email = admin@gmail.com , Password = admin@123

if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["Assign"])){
    $Cmp_id = $_POST["complaintID"];
    $team = $_POST["assignTo"];
    if(isset($Cmp_id) && isset($team)){
        echo "<script> alert('Success! Complaint Assigned Succesfully');</script>";
    }
}
?>
<!doctype html>
...
<head>
    ...
    <title>Municipal Team Dashboard - CleanSociety</title>
...
<body>
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            ...
            <a href="./_UserRecords.php#Userlist"><button type="button" class="btn btn-primary float-right ml-2">View All
                    Users </button></a>
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            ...
            <a href="./_UserRecords.php#Officiallist"><button type="button" class="btn btn-primary float-right ml-2">View All
                    Official </button></a>
